...
Title_Label = Label(Tops,font=('Comic Sans MS',16,'bold'),text = "  Gurutva Patle Presents : GUI Based CAPTCHA Generation Application    \t",bg= 'black',fg='white',justify ="center")
Title_Label.grid(row=0,column=0)
MainFrame = Frame(root,bg = 'Green',pady = 2, width =1350, height = 100, relief = RIDGE)
